...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex" style="max-width:1000px">
            <div class="w-70 mr-5" >
                <div 
                class="bg-white order-2 border-blue rounded-xl mt-16"
                style="
                ...
                <form action="" method="post" class="space-y-4 px-4 py-6">
                    ...
                    <div>
                    <select name="category_add" id="category" class="w-full rounded-xl bg-gray-100 text-sm border-none px-4 py-2">
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        ...
                        >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-600 w-5 transform -rotate-450" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <!-- <div class="w-24">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci necessitatibus esse ea nostrum delectus quae impedit expedita reiciendis fugiat aliquam, quas hic nihil rerum, soluta culpa itaque laboriosam, voluptate ipsum.
            </div> -->
        </main>
    </body>
</html>
